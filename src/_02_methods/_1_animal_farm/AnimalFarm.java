...
public class AnimalFarm {
	...
	void animals() {
		...
		/*
		 * 1. Ask the user which animal they want, then see and hear the animal they
		 * chose using one of the methods below.
		 */
		String animal = "";
		while (!animal.equalsIgnoreCase("stop")) {
			animal = JOptionPane.showInputDialog("Which animal do you want?");
			if (animal.equalsIgnoreCase("cow")) {
				...
				JOptionPane.showMessageDialog(null, "Sorry, I don't have that animal.");
			}
